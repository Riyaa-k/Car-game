...
// keys initialization
let keys = {
    ArrowUp: false, ArrowDown: false, ArrowRight: false,
    ArrowLeft: false
}
...
function startfun() {
    ...
    //     // Randomly position the enemy car horizontally anywhere within the game area
    //     enemycar.style.left = Math.floor(Math.random() * (gameArea.offsetWidth - 100)) + "px";
